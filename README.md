...
[![npm version](https://badge.fury.io/js/@hishprorg/sed-sunt.svg)](https://badge.fury.io/js/@hishprorg/sed-sunt)
[![downloads count](https://img.shields.io/npm/dt/@hishprorg/sed-sunt.svg)](https://www.npmjs.com/package/@hishprorg/sed-sunt)
[![github-ci](https://github.com/hishprorg/sed-sunt/actions/workflows/testing.yml/badge.svg)](https://github.com/hishprorg/sed-sunt/actions/workflows/testing.yml)
...
Next, install `@hishprorg/sed-sunt`:

```bash
npm install -D @hishprorg/sed-sunt
```
